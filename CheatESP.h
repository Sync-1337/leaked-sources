...
void CheatESP::DrawPlayer(cActor* pActor, bool bIsBot, bool bIsHenchMan, bool bIsHenchManNEW, bool bIsHenchManGang1, bool bIsHenchManGang2, bool bIsHenchManGang3)
{
	...
	if (!pActor->PlayerState) return;//Posted by bunyip24#9999//Posted by bunyip24#9999//Posted by bunyip24#9999//Posted by bunyip24#9999//Posted by bunyip24#9999
	if (!pActor->PlayerMesh) return;
	if (!pActor->PlayerMesh->StaticMesh) return;

	if (!Settings::Menu::ESP_OnTeam && Settings::Local::LocalTeam != 0)//Posted by bunyip24#9999
